...
void myatmyo::ContourTracing::faceDetection(){

	String face_cascade_name = "MyatMyo/haarcascade_frontalface_alt.xml";
	String eyes_cascade_name = "MyatMyo/haarcascade_eye_tree_eyeglasses.xml";
